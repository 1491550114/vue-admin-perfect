...
declare const _default: import("vue").DefineComponent<{
    ...
    onUploadImg: {
        type: PropType<(files: File[], callBack: (urls: string[]) => void) => void>;
    };
    pageFullScreen: {
    ...
    markedImage: {
        ...
        default: (href: string, title: string, desc: string) => string;
    };
}, () => JSX.Element, unknown, {}, {}, import("vue").ComponentOptionsMixin, import("vue").ComponentOptionsMixin, import("vue").EmitsOptions, "onSave" | "onChange" | "onUploadImg" | "onHtmlChanged" | "onGetCatalog", import("vue").VNodeProps & import("vue").AllowedComponentProps & import("vue").ComponentCustomProps, Readonly<import("vue").ExtractPropTypes<{
    modelValue: {
        type: PropType<string>;
        default: string;
    };
