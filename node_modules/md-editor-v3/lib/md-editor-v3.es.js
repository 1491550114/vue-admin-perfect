...
import { onMounted, onBeforeUnmount, provide, computed, defineComponent, createVNode, reactive, ref, watch, cloneVNode, nextTick, inject, mergeProps, Fragment, toRef } from "vue";
const prefix = "md";
  ...
  setup(props2) {
    ...
    return () => {
      return createVNode(Fragment, null, [createVNode("div", {
        ...
        "onInput": (e) => {
          selectedText.value = "";
          props2.onChange(e.target.value, completeStatus.value);
        },
        "onCompositionend": (e) => {
          bus.emit(editorId, "saveHistory", e.target.value);
  ...
  setup(props2) {
    return () => createVNode("div", {
      ...
      "onClick": (e) => {
        ...
        const scrollContainer = props2.scrollElement instanceof Element ? props2.scrollElement : document.querySelector(props2.scrollElement);
      ...
      "title": props2.tocItem.text
    }, [props2.tocItem.text]), createVNode("div", {
      "class": `${prefix}-catalog-wrapper`
    }, [props2.tocItem.children && props2.tocItem.children.map((item) => createVNode(CatalogLink, {
  ...
  setup(props2, context) {
    ...
    return () => {
      ...
      return createVNode("div", {
        ...
        "onChange": (value, completeStatus = true) => {
          if (completeStatus) {
